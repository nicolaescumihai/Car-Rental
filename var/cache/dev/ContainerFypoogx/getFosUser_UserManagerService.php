...
require_once $this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Model/UserManagerInterface.php';
require_once $this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Model/UserManager.php';
require_once $this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Doctrine/UserManager.php';
