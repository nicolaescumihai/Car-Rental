...
require_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/FormExtensionInterface.php';
require_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Extension/DependencyInjection/DependencyInjectionExtension.php';
require_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/FormRegistryInterface.php';
require_once $this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/FormRegistry.php';

return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CarType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CarType']) ? $this->services['AppBundle\Form\CarType'] : $this->services['AppBundle\Form\CarType'] = new \AppBundle\Form\CarType()) && false ?: '_'};
}, 'AppBundle\\Form\\ExtrasType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ExtrasType']) ? $this->services['AppBundle\Form\ExtrasType'] : $this->services['AppBundle\Form\ExtrasType'] = new \AppBundle\Form\ExtrasType()) && false ?: '_'};
}, 'AppBundle\\Form\\OrdersType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\OrdersType']) ? $this->services['AppBundle\Form\OrdersType'] : $this->services['AppBundle\Form\OrdersType'] = new \AppBundle\Form\OrdersType()) && false ?: '_'};
